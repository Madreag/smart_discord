...
- [ ] **Metadata Enrichment** (REPORT2) — Add author/channel/time context to embeddings
- [ ] **Right to be Forgotten** (REPORT3) — Complete Qdrant hard-delete on message delete

## P2 - Medium

- [ ] **GraphRAG** (REPORT4) — Thematic analysis with knowledge graphs
- [ ] **Semantic Chunking** (REPORT5) — Topic-based message grouping
